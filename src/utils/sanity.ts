...
export const client = sanityClient({
  projectId: process.env.NEXT_PUBLIC_SANITY_PROJECT_ID, // Use your env variable
  dataset: process.env.NEXT_PUBLIC_SANITY_DATASET, // Use your env variable
  apiVersion: '2023-01-01', // Use a consistent API version
  useCdn: process.env.NODE_ENV === 'production', // Use the CDN in production
