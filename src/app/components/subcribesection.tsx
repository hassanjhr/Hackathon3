  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center">
        ...
        <Link href="/products"><button className="bg-gradient-to-r from-[#7E33E0] to-[#FB2E86] font-semibold lg:h-[49px] lg:w-[173px] mt-[10px] text-white px-6 py-2  text-[17px] hover:bg-[#e0226f] transition">
          Shop Now
        </button></Link>
      </div>
    </div>
